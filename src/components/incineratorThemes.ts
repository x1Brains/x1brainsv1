...
export function injectThemeOverrides() {
  ...
  s.textContent = `
    ...
    /* purple #cc88ff → v2 orange #f29030 (primary accent) */
    .burn-theme-v2 [style*="color: rgb(204, 136, 255)"],
    .burn-theme-v2 [style*="color:#cc88ff"],
    .burn-theme-v2 [style*="color: #cc88ff"] { color: #f29030 !important; }
    ...
    /* legacy orange #ff9933 → v2 orange #f29030 */
    .burn-theme-v2 [style*="color: rgb(255, 153, 51)"],
    .burn-theme-v2 [style*="color:#ff9933"],
    .burn-theme-v2 [style*="color: #ff9933"] { color: #f29030 !important; }
    ...
    .burn-theme-v2 [style*="background:rgba(204,136,255"] {
      background: rgba(242,144,48,.08) !important;
    }
    /* purple borders → cyan */
    ...
    .burn-theme-v2 .lb-card-override {
      ...
      border-color: rgba(242,144,48,.14) !important;
    }
    .burn-theme-v2 .lb-grad-text {
      background: linear-gradient(90deg,#f29030,#00d4ff,#bf5af2) !important;
    }
  `;
