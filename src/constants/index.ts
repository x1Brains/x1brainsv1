...
// Proxied through Vite dev server → bypasses CORS.
// For production, point at your own CORS proxy or server-side relay.
...
// Set this to your deployed Anchor program address to activate minting.
// Leave as placeholder to keep the mint button disabled until deployment.
